    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                    ...
                    <form action="<?= base_url('Guru/create')?>" method="post" autocomplete="off">
                    <div class="form-group">
                        <label>Id Guru</label>
                        <input type="varchar" name="id_guru" placeholder="Masukan Mata Pelajaran" class="form-control" required autofocus>
                    </div>
                    <div class="form-group">
