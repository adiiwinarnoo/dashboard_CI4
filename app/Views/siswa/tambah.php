    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                    ...
                    <form action="<?= base_url('/tambah_siswa')?>" method="post" autocomplete="off">
                    <div class="form-group">
                        <label>Nomor Induk</label>
                        <input type="text" name="Nomor_Induk" placeholder="Masukan Nomor Induk" class="form-control" required autofocus>
                    </div>
                    <div class="form-group">
                        <label>Nama</label>
